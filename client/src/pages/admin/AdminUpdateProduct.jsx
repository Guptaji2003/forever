...
useEffect(() => {
 ...
 // Set default form data when product is fetched
  useEffect(() => {
    if (singleProduct?._id) {
      setFormData({
        name: singleProduct.name || "",
        imageUrl: singleProduct.image?.[0]?.url || "",
        alttext: singleProduct.image?.[0]?.alttext || "",
        price: singleProduct.price || "",
        category: singleProduct.category || "",
        color: singleProduct.color?.join(", ") || "",
 ...
 const handleSubmit = async (e) => {
  ...
  try {
    dispatch(updateProduct({id:id,updates:payload}));
