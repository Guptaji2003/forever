...
const AdminOrders = () => {
  ...
  return (
    <>
      <div className="max-w-7xl mx-auto w-screen px-20 p-6">
          ...
          {allOrders.map((order) => (
            ...
            >
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-4">
                ...
                <select className="w-50 p-3 rounded-md border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" name="" id="" value={status} onChange={(e)=>setstatus(e.target.value)} onClick={()=>handleStatus({id:order._id,status:status})}>
