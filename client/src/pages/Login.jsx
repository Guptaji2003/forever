...
const Login = () => {
  ...
  <div class="w-full max-w-md bg-white rounded-lg shadow-lg p-6">
    <h1 class="text-2xl font-bold text-gray-800 text-center mb-6">Login to Your Account</h1>
    ...
    <div class="mt-6">
      <button
        class="w-full flex items-center justify-center px-4 py-2 border rounded-lg text-gray-800 bg-gray-50 hover:bg-gray-100 transition"
      >
        <img
